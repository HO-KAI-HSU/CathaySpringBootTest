...
public class CurrencyTypeController {
    ...
    public ResponseEntity createcCurrencyType(@RequestBody CurrencyType currencyType) {
    ...
    public ResponseEntity upadteCurrencyType(@PathVariable Integer id, @RequestBody CurrencyType currencyType) {
